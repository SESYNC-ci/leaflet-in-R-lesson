...
```{r read_data, title = "worksheet-2.R", eval = FALSE}
library(sf)
library(raster)
library(dplyr)
...
```{r leaflet_polygons, title = "worksheet-1.R", eval = FALSE}
leaflet() %>%
  addTiles() %>%
...
```{r leaflet_polygonscolor, title = "worksheet-2.R", eval = FALSE}
leaflet() %>%
  addTiles() %>%
  addPolygons(data = counties_md, 
              color = "green", 
...
```{r leaflet_popvhov, title = "worksheet-2.R", eval = FALSE}
leaflet() %>%
  addTiles() %>%
...
```{r leaflet_pals, title = "worksheet-2.R", eval = FALSE}
leaflet() %>%
  addTiles() %>%
...
```{r leaflet_legend, title = "worksheet-2.R", eval = FALSE}
leaflet() %>%
  addTiles() %>%
  addPolygons(data = wbd_reg2, 
              fillColor = ~pal(AREA), 
...
```{r leaflet_pts, title = "worksheet-2.R", eval = FALSE}
leaflet() %>%
  addTiles() %>%
...
```{r leaflet_cluster, title = "worksheet-2.R", eval = FALSE}
leaflet() %>%
  addTiles() %>%
...
```{r leaflet_raster, title = "worksheet-2.R", eval = FALSE}
leaflet() %>%
  addTiles() %>%
  addRasterImage(nlcd)
